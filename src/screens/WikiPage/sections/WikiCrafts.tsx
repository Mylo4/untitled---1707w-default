  ...
  return (
    <div className="bg-[#161724] rounded-xl p-8 border border-[#2a2c3c]">
      ...
      <div className="prose prose-invert max-w-none">
        {/* Блок света */}
        <div className="craft-recipe bg-[rgba(255,255,255,0.05)] rounded-lg p-6 border border-[rgba(226,14,65,0.3)] mb-8">
          <h4 className="text-[#e20e41] text-xl mb-2">💡 Блок света</h4>
          ...
          <div className="flex flex-col md:flex-row items-center mb-4">
            <div className="grid grid-cols-3 gap-2 mb-4 md:mb-0 md:mr-6">
              <div className="bg-[rgba(255,255,255,0.1)] border border-[rgba(226,14,65,0.4)] rounded p-2 flex items-center justify-center">
            ...
            <div className="text-[#e20e41] text-2xl mx-4">→</div>
            <div className="bg-[rgba(226,14,65,0.2)] border-2 border-[#e20e41] rounded-lg p-4 text-center">
        ...
        {/* Невидимая рамка */}
        <div className="craft-recipe bg-[rgba(255,255,255,0.05)] rounded-lg p-6 border border-[rgba(226,14,65,0.3)] mb-8">
          <h4 className="text-[#e20e41] text-xl mb-2">🖼️ Невидимая рамка</h4>
        ...
        {/* Мешочек */}
        <div className="craft-recipe bg-[rgba(255,255,255,0.05)] rounded-lg p-6 border border-[rgba(226,14,65,0.3)] mb-8">
          <h4 className="text-[#e20e41] text-xl mb-2">🎒 Мешочек</h4>
          ...
          <div className="flex flex-col md:flex-row items-center mb-4">
            ...
            <div className="text-[#e20e41] text-2xl mx-4">→</div>
            <div className="bg-[rgba(226,14,65,0.2)] border-2 border-[#e20e41] rounded-lg p-4 text-center">
              <img src="https://c.animaapp.com/PyecxKQm/img/invicon_bundle_4.webp" alt="Мешочек" className="w-8 h-8 mx-auto mb-2" />
              <span className="text-[#e20e41] font-bold">Мешочек</span>
            </div>
          </div>
        </div>
        ...
        {/* Стекло из бетона */}
        <div className="craft-recipe bg-[rgba(255,255,255,0.05)] rounded-lg p-6 border border-[rgba(226,14,65,0.3)] mb-8">
          <h4 className="text-[#e20e41] text-xl mb-2">🔥 Стекло из бетона</h4>
          ...
          <div className="bg-[rgba(0,0,0,0.2)] p-6 rounded-lg mb-4">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <div className="text-center">
                <div className="mb-4 font-bold text-[#e20e41]">Исходный материал:</div>
              ...
              <div className="text-[#e20e41] text-3xl">🔥</div>
              <div className="text-center">
                <div className="mb-4 font-bold text-[#e20e41]">Результат:</div>
                <div className="grid grid-cols-4 gap-2">
        ...
        {/* Палочка отладки */}
        <div className="craft-recipe bg-[rgba(255,255,255,0.05)] rounded-lg p-6 border border-[rgba(226,14,65,0.3)] mb-8">
          <h4 className="text-[#e20e41] text-xl mb-2">🔮 Палочка отладки</h4>
        ...
        <div className="craft-recipe bg-[rgba(255,255,255,0.05)] rounded-lg p-6 border border-[rgba(226,14,65,0.3)] mb-8">
          <h4 className="text-[#e20e41] text-xl mb-2">🌌 Пространственный карман</h4>
        ...
        <div className="success bg-[rgba(226,14,65,0.2)] border border-[#e20e41] rounded-lg p-4 text-[#e20e41]">
